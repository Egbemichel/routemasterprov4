...
const MissionBanner: FC<MissionBannerProps> = ({
                                                         // Text content
                                                         labelText,
                                                         titleText,
                                                         descriptionText,
                                                         ...
                                                         labelColor = "text-secondary-200",
                                                         titleColor = "text-primary-200",
                                                         descriptionColor = "text-gray-color",
    ...
    return (
        <div className={`${backgroundColor} ${padding} w-full ${containerClassName} font-archivo`}>
